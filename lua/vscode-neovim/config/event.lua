...
vim.api.nvim_create_autocmd("BufEnter", {
    ...
    callback = function()
        ...
        if layout[1] == "leaf" and vim.api.nvim_get_option_value("filetype", {
...
vim.api.nvim_create_autocmd("ModeChanged", {
    pattern = "*",
    callback = function()
        if vim.api.nvim_get_mode().mode == 'n' or vim.api.nvim_get_mode().mode == 'c' or vim.api.nvim_get_mode().mode ==
            'V' then
...
vim.api.nvim_create_autocmd("FileType", {
    pattern = {"qf", "help", "man", "notify", "nofile", "lspinfo", "terminal", "prompt", "toggleterm", "copilot",
...
function autocmd.load_autocmds()
    local definitions = {
        ...
        {"BufWritePre", "/tmp/*", "setlocal noundofile"}, {"BufWritePre", "COMMIT_EDITMSG", "setlocal noundofile"},
        ...
        -- Auto toggle fcitx5
        {"InsertLeave", "* :silent", "!fcitx5-remote -c"}, {"BufCreate", "*", ":silent !fcitx5-remote -c"},
        {"BufEnter", "*", ":silent !fcitx5-remote -c "}, {"BufLeave", "*", ":silent !fcitx5-remote -c "}},
        ...
        ft = {{"FileType", "alpha", "set showtabline=0"}, {"FileType", "markdown", "set wrap"},
